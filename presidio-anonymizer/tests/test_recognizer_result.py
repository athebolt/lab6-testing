...
def test_intersects(a_start: int, a_end: int, b_start: int, b_end: int, expected: int):
    a = create_recognizer_result("a", 0, a_start, a_end)
    b = create_recognizer_result("b", 0, b_start, b_end)
